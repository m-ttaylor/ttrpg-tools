...
const RecipeItem = ({ recipe: { name, description, tags, ingredients, instructions, notes, _id } }:  RecipeProps ) => {
  ...
  return (
    ...
    <div className="w-full max-w-4xl mx-auto mb-6">
      <div>
        {/* <p className="relative text-4xl font-bold p-2">{name}
        <Link
          className="inline-flex items-center absolute right-5 my-2 py-1 px-5 ml-12 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
